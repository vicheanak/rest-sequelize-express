...
module.exports = {
  up: function (queryInterface, Sequelize) {
    ...
    var data = [
      {id: 1, name: 'Store 1', location: 'Phnom Penh', phone: '012111111', status: true,  createdAt: now, updatedAt: now, storeTypeIdStores: 1, username: 'store1012111111', password: '123456', token: ''},
      {id: 2, name: 'Store 2', location: 'Phnom Penh', phone: '012222222', status: true,  createdAt: now, updatedAt: now, storeTypeIdStores: 2, username: 'store2012222222', password: '123456', token: ''},
